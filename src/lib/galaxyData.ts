  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description: 'Visual builder for Model Context Protocol servers. Drag-and-drop tools, real-time testing, and instant TypeScript code generation. Built in 4 hours.',
        role: 'Creator',
        tags: ['MCP', 'React Flow', 'Monaco Editor', 'Zustand', 'Next.js 15'],
        color: '#00D9FF',
        brightness: 2.0,
        size: 'large',
        galaxy: 'ai',
        links: { live: 'https://mcp-server-studio.vercel.app', github: 'https://github.com/yourusername/mcp-server-studio' },
        featured: true,
        dateRange: '2026',
        ...
        solution: 'Built a React Flow canvas for visual tool design, Monaco Editor for code preview, test simulator with keyword matching, and production-ready TypeScript code generator. Shipped MVP in 4 hours.',
        impact: 'Futuristic glassmorphism UI showcases cutting-edge design skills. Complete workflow: design → test → export in one tool. 8 pre-built templates accelerate development.',
      },
      {
        id: 'ai-artist',
      ...
      },
      {
        ...
        size: 'medium',
        galaxy: 'ai',
        links: { github: 'https://github.com/forbiddenlink/autonomous-artist' },
        featured: false,
        dateRange: '2025',
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        size: 'large',
        galaxy: 'fullstack',
        links: { live: 'https://quantum-forge-self.vercel.app', github: 'https://github.com/forbiddenlink/kindred' },
        featured: true,
        dateRange: '2024',
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        featured: false,
        dateRange: '2025',
        challenge: 'Creating genuine atmosphere and mood through web design—making visitors feel something, not just see something.',
        solution: 'Layered fog effects, ambient audio, flickering elements, and pacing that builds tension. Every interaction designed for unease.',
        impact: 'Atmospheric effects create genuine mood shifts. Sound design enhances immersion. Demonstrates that web can be an emotional medium.',
      },
      {
        id: 'canvas-flow',
        title: 'Canvas Flow',
      ...
      },
      {
        ...
        size: 'large',
        galaxy: 'experimental',
        links: { github: 'https://github.com/forbiddenlink/particle-system' },
        featured: true,
        dateRange: '2025',
      ...
      },
      {
        ...
        size: 'large',
        galaxy: 'experimental',
        links: { github: 'https://github.com/forbiddenlink/app-idea-miner' },
        featured: true,
        dateRange: '2025',

...
export const galaxies: Galaxy[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        size: 'medium',
        galaxy: 'enterprise',
        links: { live: 'https://hephaestusinternational.com' },
        featured: false,
        dateRange: '2024',
      },
      {
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        id: 'beads',
        title: 'Beads',
        description: 'Creative bead design and craft planning application with pattern generation.',
        role: 'Creator',
        tags: ['Creative', 'Design Tool', 'Patterns', 'React'],
        color: '#FFB800',
        brightness: 1.2,
        size: 'small',
        galaxy: 'experimental',
      ...
      },
      {
        ...
        size: 'medium',
        galaxy: 'experimental',
        links: { live: 'https://pollyglot-elizabeth-emersons-projects.vercel.app' },
        featured: true,
        dateRange: '2025',
      },
      {
